 ...
 */
final class Version20241210155120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE user SET email = "default@example.com"');
        // $this->addSql('ALTER TABLE user CHANGE email email VARCHAR(255) NOT NULL');
        //$this->addSql('ALTER TABLE user MODIFY COLUMN email VARCHAR(255) NOT NULL');
    }
